...
sales_this_month = df_payments['usd_amount'].where(df_payments['payment_date'].month == current_month && df_payments['payment_date'].year == current_year).sum()
sales_last_month = df_payments['usd_amount'].where(df_payments['month_date']).sum()
