...
df_contracts_sales = conn.query('''WITH interest_dates as (
    SELECT * FROM (VALUES (1, '2025-02-01'),(2, '2025-01-01'), (3, '2024-12-01'), (4, '2024-11-01'), (5, '2024-10-01'),(6, '2024-09-01'),(7, '2024-08-01'), (8, '2024-07-01'), (9, '2024-06-01'), (10, '2024-05-01'), (11, '2024-04-01'), (12, '2024-03-01'), (13, '2024-02-01')) AS t (num,d_date)
    ) 
