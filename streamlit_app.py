...
sales_this_month = df_payments['usd_amount'].where(df_payments['payment_date']=='2024-11').sum()
sales_last_month = df_payments['usd_amount'].where(df_payments['payment_date']=='2024-10').sum()
st.metric(label="This Month", value=numerize(sales_this_month),delta=numerize(sales_this_month - sales_last_month))
