...
df_payments = conn.query('SELECT a.amount,a.currency,to_char(a.payment_date,"YYYY-MM") as payment_date,a.bank_account_identifier,a.uuid,b.name FROM client_payments a JOIN clients b on a.client_uuid = b.uuid;', ttl="10m")
